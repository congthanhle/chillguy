...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['comment'])){
	...
	$mail->Username="congthanhle225@gmail.com";  // Your Mail
	$mail->Password="Your App Password"; // Your app password

	$mail->setFrom($email, $name);  
	$mail->addAddress("congthanhle225@gmail.com", "Le Cong Thanh"); // (Your Mail) An email address that will receive the email with the output of the form
